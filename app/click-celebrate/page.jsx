      ...
      <section className="pumpea-container pb-20">
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {features.map((feature) => (
            <article key={feature.title} className="glass-card reveal-card p-5 sm:p-7">
      ...
      <section className="pumpea-container pb-24">
        <div className="texture-panel grid items-center gap-6 p-5 text-white sm:p-7 md:grid-cols-[1fr_auto] md:gap-8 md:p-10">
          <div>
            ...
            <h2 className="mt-6 font-heading text-[29px] font-black leading-tight sm:text-3xl md:text-5xl">Gestiona, transmite y celebra sin perder control.</h2>
          ...
          <a href="https://wa.me/5217293062147?text=%C2%A1Hola!%20Estoy%20interesado%20en%20Click%26Celebrate%20de%20Pumpea" target="_blank" rel="noopener noreferrer" className="cta-button w-full !bg-white !text-blue-700 md:min-w-[260px]">
