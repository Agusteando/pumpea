...
export default function Pricing() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 relative">
      <h1 className="text-3xl md:text-4xl font-heading mb-5 text-center">
        Precios y Paquetes
      </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-10">
        {packages.map((p) => (
          <div key={p.title} className="bg-white rounded-xl shadow p-6 flex flex-col justify-between border border-gray-100">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-green-500 text-lg"><i className="fa fa-circle mr-2 align-middle" /></span>
      ...
      <div className="bg-gray-50 rounded-lg shadow px-5 py-8 mb-4">
