...
export default function Footer() {
  return (
    <footer className="mt-10 border-t border-blue-100/80 bg-white/50 backdrop-blur-xl">
      <div className="pumpea-container grid gap-8 py-10 md:grid-cols-[1fr_auto] md:items-center">
        <div>
          <img src="/logo-h.png" alt="Pumpea Tecnología" className="h-12 w-auto" />
        ...
        <div className="flex flex-wrap gap-4 text-sm font-bold text-slate-600 md:justify-end">
